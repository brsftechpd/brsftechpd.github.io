    ...
    urlTemplates: {
        ...
        appServices: {
            ...
            photo: {
                ...
                icon: "fas fa-camera",
                gradient: "photo-btn",
                url: "http://opensearch-prod-pudsmig.passport.local/app/data-explorer/discover?security_tenant=global#?_a=(discover:(columns:!(message,app,properties.uuid,http.request.uri,http.request.body,url,callsite,errcode,level),isDirty:!t,sort:!()),metadata:(indexPattern:f6641370-7753-11f0-8ccc-413df0814dca,view:discover))&_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-7d,to:now))&_q=(filters:!(('$state':(store:appState),meta:(alias:!n,disabled:!f,index:f6641370-7753-11f0-8ccc-413df0814dca,key:app,negate:!f,params:(query:photo),type:phrase),query:(match_phrase:(app:photo))),('$state':(store:appState),meta:(alias:!n,disabled:!f,index:f6641370-7753-11f0-8ccc-413df0814dca,key:url,negate:!f,params:(query:photo%2Fidentification),type:phrase),query:(match_phrase:(url:photo%2Fidentification))),('$state':(store:appState),meta:(alias:!n,disabled:!f,index:f6641370-7753-11f0-8ccc-413df0814dca,key:properties.uuid,negate:!f,params:(query:'{userId}'),type:phrase),query:(match_phrase:(properties.uuid:'{userId}')))),query:(language:kuery,query:''))"
            },
            photo2: {
                name: "Идентификация",
                icon: "fas fa-camera",
